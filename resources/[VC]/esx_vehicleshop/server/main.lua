...
RegisterServerEvent('esx_vehicleshop:setVehicleVCOwned')
AddEventHandler('esx_vehicleshop:setVehicleVCOwned', function (vehicleProps, society)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedVCPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedVCPlayerId', function (playerId, vehicleProps)
	local _source = source
...
RegisterServerEvent('esx_vehicleshop:setVehicleVCOwnedSociety')
AddEventHandler('esx_vehicleshop:setVehicleVCOwnedSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
