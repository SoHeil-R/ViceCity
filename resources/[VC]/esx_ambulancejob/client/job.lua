					...
					if data.current.value == 'revive' then
						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								ESX.TriggerServerCallback('esx_ambulancejob:checkinjure', function(Dead)
									print(Dead[1].InJure)
								if Dead[1].InJure then
										ESX.UI.Menu.CloseAll()
										...
										TriggerServerEvent('esx_ambulancejob:VreviveC', GetPlayerServerId(closestPlayer))
										-- Show revive award?
