...
Citizen.CreateThread(function()
	while true do
		...
		if isGpsOn then
			drawTxt3(x-0.325, y+0.36, 1.0,1.0,0.45, "~y~ID: ~w~" .. GetPlayerServerId(PlayerId()) .. " | " .. timestamp  , town_r, town_g, town_b, town_a)
		else
			drawTxt3(x-0.325, y+0.43, 1.0,1.0,0.45, "~y~ID: ~w~" .. GetPlayerServerId(PlayerId()) .. " | " .. timestamp  , town_r, town_g, town_b, town_a)
		end
		
		--[[HideHudComponentThisFrame(9)
		HideHudComponentThisFrame(7)
		SetHudComponentPosition(6, 0, 0.01)--]]
