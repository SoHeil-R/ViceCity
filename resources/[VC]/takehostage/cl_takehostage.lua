...
Citizen.CreateThread(function()
	while true do 
		if holdingHostage then
			...
			DisableControlAction(0,36,true) -- disable aim
			...
			DrawText3D(playerCoords.x,playerCoords.y,playerCoords.z,"Raha kardan [G], Koshtan [H]")
		...
		if beingHeldHostage then 
			...
			DisableControlAction(0,25,true) -- disable aim
			DisableControlAction(0,36,true) -- disable aim
			DisableControlAction(0,243,true) -- disable aim
			DisableControlAction(0,47,true) -- disable weapon
			DisableControlAction(0,58,true) -- disable weapon
			...
			DisableControlAction(0,62,true)
			DisableControlAction(0,132,true1)
			DisableControlAction(0,224,true)
			DisableControlAction(0,280,true)
			DisableControlAction(0,281,true)
			DisableControlAction(0,326,true)
