...
RegisterServerEvent('esx_mechanicjob:startVCHarvest')
AddEventHandler('esx_mechanicjob:startVCHarvest', function()
...
RegisterServerEvent('esx_mechanicjob:startVCHarvest2')
AddEventHandler('esx_mechanicjob:startVCHarvest2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:startVCHarvest3')
AddEventHandler('esx_mechanicjob:startVCHarvest3', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:startVCCraft')
AddEventHandler('esx_mechanicjob:startVCCraft', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:startVCCraft2')
AddEventHandler('esx_mechanicjob:startVCCraft2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:startVCCraft3')
AddEventHandler('esx_mechanicjob:startVCCraft3', function()
	local _source = source
