...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -204.67, y = -1342.75, z = 29.89 },
	...
	VehicleSpawnPoint = {
		Pos   = { x = -188.22, y = -1347.06, z = 30.99 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -183.6, y = -1334.8, z = 30.3 },
