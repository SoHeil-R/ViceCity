...
$(document).ready(function () {
    ...
    $("#craft").click(function(event,ui){
        $.post("http://esx_inventoryhud/CreaftItem", JSON.stringify({}));
      });
    $('#playerInventory').droppable({
        drop: function (event, ui) {
            ...
            } else if (type === "normal" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromCraft", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
    ...
    $('#otherInventory').droppable({
        drop: function (event, ui) {
            ...
            if (type === "trunk" && itemInventory === "main") {
                ...
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoCraft", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
